table(toLower(products)).DataTable({
    ...
    "columns": [
        {
            render: function(data, type, row, meta) {
              return '<div class="checkbox"><label class="checkbox-container"><input type="checkbox" class="checkProducts" name="products[]" value="' + row.ui + '"><span class="checkmark"></span></label></div>'
            },
            searchable: false,
            sortable: false,
        },
