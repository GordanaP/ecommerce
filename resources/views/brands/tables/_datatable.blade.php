table(toLower(brands)).DataTable({
    ...
    "columns": [
        {
            render: function(data, type, row, meta) {
              return '<div class="checkbox"><label class="checkbox-container"><input type="checkbox" class="checkBrands" name="brands[]" value="' + row.ui + '"><span class="checkmark"></span></label></div>'
            },
            searchable: false,
            sortable: false,
        },
